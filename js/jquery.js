...
function change_region() {
    $("#regions_footer").change(function() {
        var e = $(this).val();
        0 == e ? $(".address_regions .regions").show() : ($(".address_regions .regions").hide(),
        $(".regions_" + e).show())
    })
}
function fb_support_online() {
    jQuery(".chat_fb").click(function() {
        jQuery(".fchat").toggle("slow", function(e) {
            "none" == $(".fchat").css("display") ? ($(".chat_fb").addClass("chat_fb_closed").removeClass("chat_fb_openned"),
            $("#cfacebook").css("width", "auto")) : ($(".chat_fb").removeClass("chat_fb_closed").addClass("chat_fb_openned"),
...
$(function() {
    ...
    $(window).scroll(function() {
        st = $(this).scrollTop(),
        Itid = $("#Itid").val(),
        e > 950 ? st > 100 ? st < s ? $(".header_wrapper").removeClass("slide-down").addClass("slide-up").css({
            position: "fixed",
            top: "0px"
        ...
        $("#menu-fixed-bar").removeClass("m-menu-fix")) : ($("#header_inner").css({
            position: "initial"
        }).removeClass("m-slide-up").removeClass("m-slide-down"),
...
;function load_product(a, e, t) {
    $.ajax({
        ...
        cache: !1,
        success: function(e) {
            $("#box_product_" + a).html(e),
            $(".item_tabs").removeClass("active"),
            $("#item_tab_" + a + "_" + t).addClass("active")
        }
    })
}
;!function(e) {
    ...
    t.prototype = {
        initialize: function() {
            var n, o = this, s = "." + o.classes.suggestion, i = o.classes.selected, a = o.options;
        ...
        isCursorAtEnd: function() {
            ...
            return "number" == typeof o ? o === n : !document.selection || ((e = document.selection.createRange()).moveStart("character", -n),
            n === e.text.length)
        },
        ...
        onValueChange: function() {
            if (this.ignoreValueChange)
                ...
                var t = this
                  ...
                  , o = t.el.val()
                  , s = t.getQuery(o);
                t.selection && t.currentValue !== s && (t.selection = null,
                (n.onInvalidateSelection || e.noop).call(t.element)),
                clearTimeout(t.onChangeTimeout),
                t.currentValue = o,
                t.selectedIndex = -1,
                n.triggerSelectOnValidInput && t.isExactMatch(s) ? t.select(0) : s.length < n.minChars ? t.hide() : t.getSuggestions(s)
            }
        },
        ...
        getQuery: function(t) {
            ...
            return o ? (n = t.split(o),
            e.trim(n[n.length - 1])) : t
        },
        getSuggestionsLocal: function(t) {
            var n, o = this.options, s = t.toLowerCase(), i = o.lookupFilter, a = parseInt(o.lookupLimit, 10);
            return n = {
        ...
        getSuggestions: function(t) {
            var n, o, s, i, a = this, u = a.options, r = u.serviceUrl;
            u.params[u.paramName] = t,
            !1 !== u.onSearchStart.call(a.element, u.params) && (o = u.ignoreParams ? null : u.params,
            e.isFunction(u.lookup) ? u.lookup(t, function(e) {
                a.suggestions = e.suggestions,
                a.suggest(),
                u.onSearchComplete.call(a.element, t, e.suggestions)
            }) : (a.isLocal ? n = a.getSuggestionsLocal(t) : (e.isFunction(r) && (r = r.call(a.element, t)),
            s = r + "?" + e.param(o || {}),
            n = a.cachedResponse[s]),
            n && Array.isArray(n.suggestions) ? (a.suggestions = n.suggestions,
            a.suggest(),
            u.onSearchComplete.call(a.element, t, n.suggestions)) : a.isBadQuery(t) ? u.onSearchComplete.call(a.element, t, []) : (a.abortAjax(),
            i = {
                url: r,
                data: o,
                type: u.type,
        ...
        suggest: function() {
            if (this.suggestions.length) {
                var t, n = this, o = n.options, s = o.groupBy, i = o.formatResult, a = n.getQuery(n.currentValue), u = n.classes.suggestion, r = n.classes.selected, l = e(n.suggestionsContainer), c = e(n.noSuggestionsContainer), g = o.beforeRender, d = "", p = function(e, n) {
                    var i = e.data[s];
                    return t === i ? "" : (t = i,
                    o.formatGroup(e, t))
                };
                ...
                n.fixPosition(),
                l.show(),
                o.autoSelectFirst && (n.selectedIndex = 0,
                l.scrollTop(0),
        ...
        adjustContainerWidth: function() {
            ...
            "auto" === o.width ? (t = n.el.outerWidth(),
            s.css("width", t > 0 ? t : 300)) : "flex" === o.width && s.css("width", "")
        },
        ...
        processResponse: function(e, t, n) {
            ...
            s.noCache || (o.cachedResponse[n] = e,
            s.preventBadQueries && !e.suggestions.length && o.badQueries.push(t)),
            t === o.getQuery(o.currentValue) && (o.suggestions = e.suggestions,
            o.suggest())
        },
        activate: function(t) {
            var n, o = this, s = o.classes.selected, i = e(o.suggestionsContainer), a = i.find("." + o.classes.suggestion);
            return i.find("." + s).removeClass(s),
            o.selectedIndex = t,
            -1 !== o.selectedIndex && a.length > o.selectedIndex ? (n = a.get(o.selectedIndex),
            e(n).addClass(s),
            n) : null
        },
        selectHint: function() {
        ...
        moveUp: function() {
            var t = this;
            if (-1 !== t.selectedIndex)
                return 0 === t.selectedIndex ? (e(t.suggestionsContainer).children("." + t.classes.suggestion).first().removeClass(t.classes.selected),
                t.selectedIndex = -1,
        ...
        adjustScroll: function(t) {
            ...
            if (o) {
                ...
                s < i ? e(n.suggestionsContainer).scrollTop(s) : s > a && e(n.suggestionsContainer).scrollTop(s - n.options.maxHeight + u),
                n.options.preserveInput || (n.ignoreValueChange = !0,
        ...
        getValue: function(e) {
            var t, n, o = this, s = o.options.delimiter;
            return s ? (t = o.currentValue,
            n = t.split(s),
    ...
    e.fn.devbridgeAutocomplete = function(n, o) {
        return arguments.length ? this.each(function() {
            ...
            "string" == typeof n ? i && "function" == typeof i[n] && i[n](o) : (i && i.dispose && i.dispose(),
            i = new t(this,n),
...
;function submit_form_search() {
    ...
    if ("" != e) {
        ...
        var r = 0;
    return 0 == r ? (alert("Bạn phải nhập tham số tìm kiếm"),
    !1) : (link = a.replace("keyword", e),
    ...
    $("#keyword").autocomplete({
        ...
        formatResult: function(e, a) {
            ...
            for (j = 0; j < r.length; j++)
                n += a.toLowerCase().indexOf(r[j].toLowerCase()) >= 0 ? "<strong>" + r[j] + "</strong> " : r[j] + " ";
...
;$('.videos_block_body .video_item .video_item_inner_has_img').click(function() {
    ...
    $(this).html('<iframe src="' + link_video + '?rel=0&autoplay=1" width="100%" height="264" frameborder="0" allowfullscreen="false">');
